// python은 대부분이 calss로 되어 있다.
// javascript => class가 ES6부터 나온 문법입니다. 원래 있던 문법이 아니고
// 그 전에는 생성자 함수로 사용했었습니다.

let myArr = new Array(1, 2, 3); // python에서 마치 클래스로 인스턴스를 만들어내듯 찍는것
...
// child가 parent에 메서드나 맴버를 사용할 수 있다.
